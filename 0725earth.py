...
if st.session_state.bookmarks: # 북마크가 있을 때만 지도 생성
    ...
    m = folium.Map(location=[first_bookmark['latitude'], first_bookmark['longitude']], zoom_start=10)
    ...
    for bookmark in st.session_state.bookmarks:
        ...
        folium.Marker(
            ...
            icon=folium.Icon(color="red", icon="map-marker", prefix="fa") # 아이콘 색상, 모양, 스타일을 지정 (Font Awesome 사용)
        ).add_to(m) # 지도에 마커를 추가!
