...
st.info(
    ...
    "AI 교육원 설립 추진 등 미래 교육을 위해 정말 힘쓰는 곳이랍니다! [【1】](https://www.gen.go.kr/sub/page.php?page_code=introduce_06_04_06), [【2】](https://gwangju.grandculture.net/gwangju/seogu/index?category=%EC%A7%80%EB%AA%85%2F%EA%B8%B0%EA%B4%80%EB%AA%85&depth=2&name=%EA%B0%80&page=11&search=%EA%B4%91%EC%A3%BC%EA%B4%91%EC%97%AD%EC%8B%9C%EA%B5%90%EC%9C%A1%EC%97%B0%EA%B5%AC%EC%A0%95%EB%B3%B4%EC%9B%90),  "
    "최근에는 중등 영재캠프도 운영하고 전국 최초로 교육행정데이터를 연동하기도 했어요. [【2】](https://gwangju.grandculture.net/gwangju/seogu/index?category=%EC%A7%80%EB%AA%85%2F%EA%B8%B0%EA%B4%80%EB%AA%85&depth=2&name=%EA%B0%80&page=11&search=%EA%B4%91%EC%A3%BC%EA%B4%91%EC%97%AD%EC%8B%9C%EA%B5%90%EC%9C%A1%EC%97%B0%EA%B5%AC%EC%A0%95%EB%B3%B4%EC%9B%90), [【4】](https://bizno.net/article/4108306053)"
)
st.markdown("---")
...
with st.form("new_bookmark_form", clear_on_submit=True):
    ...
    lat = st.number_input("⬆️ 위도", format="%.6f", value=37.500000, help="지도의 세로선 위치 (한국은 보통 33 ~ 38 사이)")
    lon = st.number_input("➡️ 경도", format="%.6f", value=127.000000, help="지도의 가로선 위치 (한국은 보통 126 ~ 129 사이)")
