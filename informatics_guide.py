...
career_data = {
    "<span style='font-size: 1.2em;'>💻 컴퓨터/소프트웨어 분야": { # 이 문자열 자체가 키가 되는 거야!
        ...
        "관련 직업": ["소프트웨어 개발자", "웹 개발자", "앱 개발자", "게임 프로그래머", "정보 보안 전문가"],
        "관련 학과": ["컴퓨터공학과", "소프트웨어학과", "정보통신공학과", "사이버보안학과"]
    },
    "<span style='font-size: 1.2em;'>🧠 데이터/AI 분야": {
        "설명": "방대한 데이터를 수집, 분석하고 인공지능 기술을 개발하거나 활용하는 분야예요. 미래 사회에서 가장 중요해질 분야 중 하나죠.",
        "관련 직업": ["데이터 과학자", "데이터 분석가", "인공지능 개발자", "머신러닝 엔지니어", "빅데이터 전문가"],
        "관련 학과": ["데이터사이언스학과", "인공지능학과", "통계학과 (데이터 분석 트랙)", "산업공학과"]
    },
    "<span style='font-size: 1.2em;'>🔗 융합 기술 분야": {
        "설명": "정보 기술을 다른 분야와 결합하여 새로운 가치를 창출하는 분야예요. 정보교과의 융합적 사고력이 빛을 발하는 곳이죠!",
        "관련 직업": ["로봇 공학자", "스마트팜 전문가", "디지털 헬스케어 개발자", "핀테크 전문가", "에듀테크 개발자"],
