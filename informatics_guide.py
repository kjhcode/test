...
우리 학교 정보교과 수업은  <br> 
이론과 실습의 균형을 맞춰 진행돼요.  <br> 
최신 컴퓨터 실습실에서 파이썬, C++ 등 다양한 프로그래밍 언어를 배우고,  <br> 
직접 프로그램을 만들어보는 활동을 많이 해요.

특히,해커톤, 로봇대회 및 데이터 분석 프로젝트 발표회 같은 교외/내 활동과 연계해서 배우는 내용을 더 깊이 탐구할 기회가 많아요.  <br> 
...
st.markdown("""
정보교과는  <br> 
너의 잠재력을 깨우고 미래를 설계하는 데 훌륭한 도구가 될 거야. <br>
