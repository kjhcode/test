...
for i, question in enumerate(aptitude_questions):
    ...
    with col_apt:
        ...
        # Streamlit will automatically update st.session_state[f"aptitude_{i}"]
        # Removed the direct assignment here!
        st.checkbox("", key=f"aptitude_{i}", label="") # label="" keeps the checkbox itself clean
...
st.header("🎉 너의 빛나는 미래를 응원해! ❤️") # 헤더에 하트 아이콘 추가
st.write("""
