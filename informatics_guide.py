...
st.header("📚 정보과목를 선택하면 좋은 점!") # 헤더 아이콘 유지
...
# 정보교과 5가지 영역 - 아이콘 변경
info_areas = {
    " <span style='font-size: 0.9em;'>💻 컴퓨팅 시스템</span>": "컴퓨터가 어떻게 작동하는지, 하드웨어와 소프트웨어의 기본 원리를 이해함.", # 아이콘 크기 조절
    " <span style='font-size: 0.9em;'>📈 데이터</span>": "다양한 데이터를 수집하고 분석해서 의미 있는 정보를 찾아내는 방법을 배움.", # 아이콘 크기 조절
    " <span style='font-size: 0.9em;'>🧩 알고리즘과 프로그래밍 </span>": "문제를 해결하기 위한 절차(알고리즘)를 설계하고, 컴퓨터 언어(파이썬 등)로 프로그램을 만드는 연습을 함.", # 아이콘 크기 조절
    " <span style='font-size: 0.9em;'>🤖 인공지능 </span>": "스스로 학습하고 판단하는 인공지능의 기본 개념과 활용 사례를 탐구함.", # 아이콘 크기 조절
    " <span style='font-size: 0.9em;'>🌐 디지털 문화 </span>": "디지털 세상에서의 올바른 윤리 의식과 시민 역량을 기름." # 아이콘 크기 조절
}
