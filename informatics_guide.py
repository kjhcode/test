...
st.header("📚 일반선택 과목 중 정보교과에서 무엇을 배울까요? (2022 개정 교육과정 기준)") # 헤더 아이콘 유지
st.markdown("""
...
st.header("📚 진로선택 과목 중 인공지능기초 교과에서 무엇을 배울까요? (2022 개정 교육과정 기준)") # 헤더 아이콘 유지
st.markdown("""
...
st.header("📚 진로선택 과목 중 데이터과학 교과에서 무엇을 배울까요? (2022 개정 교육과정 기준)") # 헤더 아이콘 유지
st.markdown("""
...
st.header("📚 융합선택 과목 중 소프트웨어와 생활 교과에서 무엇을 배울까요? (2022 개정 교육과정 기준)") # 헤더 아이콘 유지
st.markdown("""
...
st.header("📚 진로선택 과목 중 정보과학 교과에서 무엇을 배울까요? (2022 개정 교육과정 기준)") # 헤더 아이콘 유지
st.markdown("""
