...
subject_data = {
    ...
    "자연과학 계열": {
        ...
        "관련 과목 (예시)": ["물리학", "화학", "생명과학", "지구과학"],
        "관련 진로/학과 (예시)": ["물리학과", "화학과", "생명과학과", "수학과"]
    },
    "공학 계열": {
        "설명": "새로운 기술을 개발하고 문제를 해결하는 것에 관심이 많다면 도전!",
        "관련 과목 (예시)": ["미적분", "기하", "물리학", "화학", "정보", "인공지능 기초", "데이터 과학"],
        "관련 진로/학과 (예시)": ["컴퓨터공학과", "전자공학과", "기계공학과", "건축학과"]
    },
    "의약학 계열": {
        "설명": "사람이나 동물의 건강, 질병 치료에 기여하고 싶다면?",
        "관련 과목 (예시)": ["생명과학", "화학", "미적분", "확률과 통계"],
        "관련 진로/학과 (예시)": ["의예과", "치의예과", "한의예과", "수의예과", "약학과", "간호학과"]
    },
     "예술·체육 계열": {
        "설명": "음악, 미술, 체육 등 예체능 분야에 재능과 열정이 있다면!",
        "관련 과목 (예시)": ["음악", "미술", "체육", "음악 연주와 창작", "미술 창작", "스포츠 과학"],
...
2.  **진로 정보를 찾아봐:** 희망하는 대학 학과나 직업에서 어떤 과목을 중요하게 생각하는지 알아보자.
3.  **선생님, 선배님과 상담해 봐:** 혼자 고민하기 어렵다면 주변에 도움을 요청하는 것도 좋은 방법이야.
4.  **과목 내용을 미리 살펴보자:** 과목 이름만 보고 판단하기 어렵다면, 교육과정 정보나 교과서 목차 등을 미리 살펴보는 것도 좋아.
""")
